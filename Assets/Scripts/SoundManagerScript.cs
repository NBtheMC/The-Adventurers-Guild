...
{
    public static AudioClip bellSound, bookCloseSound, bookOpenSound, bookPage1Sound, bookPage2Sound, bookPage3Sound, parchment1Sound, parchment2Sound, parchment3Sound, slipDown1Sound, slipDown2Sound, slipUp1Sound, slipUp2Sound, stampSound, coinsSound, dayStartSound, dayEndSound;
    ...
    public static void PlaySound (string clip)
    {
        switch (clip)
        {
            ...
            case "coins":
                ...
                break;
            case "dayStart":
                audioSrc.PlayOneShot(dayStartSound);
                break;
            case "dayEnd":
                audioSrc.PlayOneShot(dayEndSound);
                break;
